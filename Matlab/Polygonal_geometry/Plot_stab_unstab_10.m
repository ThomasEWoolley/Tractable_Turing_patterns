...
load Plotting_indices_n10p3.mat
...
Turner=(ps.mesh.bp(1,:)+1i*ps.mesh.bp(2,:)).*exp(-1i*2*pi/10*2);ps.mesh.bp=[real(Turner);imag(Turner)];
...
load Plotting_indices_n10p4.mat
[~,I]=sort(Possible_vecs(:,5));
Possible_vecs=Possible_vecs(I,:);
Unstable_sol_index=Possible_vecs(Possible_vecs(:,3)==1,:);
Stable_sol_index=Possible_vecs(Possible_vecs(:,3)==0,:);
...
export_fig('./Pictures/n10_stab_unstab.png','-r300')
