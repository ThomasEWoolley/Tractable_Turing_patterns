...
num_of_corners=4;
Fname=['Corners_test_',num2str(num_of_corners)];
% 
%     if exist(Fname, 'dir')
%        rmdir([Fname,'*'],'s')
%     end
...
pde=Polys4(1,10,num_of_corners,0.05); p.pdeo=pde; 
...
p.nc.lammin=2; % Min parameter value
...
p=swibra('Corners_test_4_bp1_b','bpt1',['Corners_test_4_bp1_b_bp1_f'],0.001);
p.plot.bpcmp=2;
p.plot.pcmp=1; % Component for plotting
p.nc.dsmax=0.01; % Arclength max steplength
p.nc.lammax=20; % Max parameter value
...
p=swibra('Corners_test_4_bp1_b','bpt3',['Corners_test_4_bp1_b_bp3_b'],-0.001);
p.plot.bpcmp=2;
p.plot.pcmp=1; % Component for plotting
p.nc.dsmax=0.01; % Arclength max steplength
p.nc.lammax=20; % Max parameter value
...
p=swibra(Fname,'bpt4',[Fname,'_bp4_b'],-0.001);
p.plot.bpcmp=2;
p.plot.pcmp=1; % Component for plotting
p.nc.dsmax=0.01; % Arclength max steplength
p.nc.lammax=20; % Max parameter value
...
% n=3;
% fn='Corners_';
% plotbra([fn,num2str(n)],'ms',0,'wnr',2,'cmp',2)
% plotbra([fn,num2str(n)],'ms',0,'wnr',2,'cmp',3)
% plotbra([fn,num2str(n),'_bp1_f'],'ms',0,'wnr',2,'cmp',2)
% plotbra([fn,num2str(n),'_bp1_f'],'ms',0,'wnr',2,'cmp',3)
% plotbra([fn,num2str(n),'_bp3_f'],'ms',0,'wnr',2,'cmp',2)
% plotbra([fn,num2str(n),'_bp3_f'],'ms',0,'wnr',2,'cmp',3)
% plotbra([fn,num2str(n),'_bp3_b'],'ms',0,'wnr',2,'cmp',2)
% plotbra([fn,num2str(n),'_bp3_b'],'ms',0,'wnr',2,'cmp',3)
% 
% p=swibra('Corners_3_bp1_b','bpt2','Corners_3_bp1_bp1_b',0.001);
% p.plot.bpcmp=2;
% p.plot.pcmp=1; % Component for plotting
% p.nc.dsmax=0.01; % Arclength max steplength
% p.nc.lammax=20; % Max parameter value
